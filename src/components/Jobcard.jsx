                                ...
                                <CardContent>
                                    <Stack spacing={2}>
                                        ...
                                        <div className="details">
                                            ...
                                            <a href="#" 
                                            onClick={() => handleLoadMore(index)} className="showMoreLink">
                                                View Job
                                            </a>
                                            {item.minExp && (
                                                <Typography color="textSecondary" className="experience">
                                                    Minimum Experience: <br />{item.minExp} years
                                                </Typography>
                                            )}
                                            <Button component="a" variant="contained" color="primary" href={item.jdLink} className="applyButton" 
                                            style={{ backgroundColor: teal[600] }} startIcon={<FlashOnIcon style={{ color: yellow[500]}}  />}>
                                                Easy Apply
                                            </Button>
                                        </div>
                                    </Stack>
